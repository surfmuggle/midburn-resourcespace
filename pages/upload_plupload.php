...
if ($collection_add=="new" && !$upload_then_edit && !$global_edit_then_upload_then_edit)
	{
...
elseif ($upload_then_edit || $global_edit_then_upload_then_edit)
	{
	if (!$global_edit_then_upload_then_edit) {
		# Switch to the user's special upload collction.
                        ...
                        uploader.bind('FileUploaded', function(up, file, info) {
                                ...
                                if (info.response.indexOf("error")>0)
                                        ...
                                        if(show_upload_log)
                                            ...
                                            if (uploaderrormessage.indexOf("error")>0) alert(uploaderrormessage + "\n\n"+info.response);
                                            }
                                        }
...
jQuery(document).ready(function () {            
  var uploader = jQuery("#pluploader").plupload<?php if(!$plupload_widget) { ?>Queue<?php } ?>(pluploadconfig);
